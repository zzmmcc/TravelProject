...
<div class="wrap">
    ...
    <table class="list-style">
        <tr>
            ...
            <td><input type="text" readonly class="textBox length-long" name="rid" style="border: none;outline: none;"
                       value="${routeMsg.route.rid}"/></td>
        </tr>
        <tr>
            <td style="text-align:right;width:25%;">路线名称：</td>
            <td><input type="text" style="width: 70%;border: none;outline: none;" readonly class="textBox length-long"
                       name="rname" value="${routeMsg.route.rname}"/></td>
        </tr>
        <form action="/TravelProject/adminRouteServlet?method=upPic&rid=${routeMsg.route.rid}"
