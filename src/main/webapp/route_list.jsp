    ...
    <div class="page_one">
        <div class="contant">
            ...
            <div class="xinxi clearfix">
                ...
                <div class="pageNum">
                    <ul id='writePage'>
                        <li><a href=routeServlet?method=getRouteListByCid&cid=${pageList.list[0].cid}&pageNow=1'>首页</a>
                        </li>
                        <li class="threeword"><a
                                href='routeServlet?method=getRouteListByCid&cid=${pageList.list[0].cid}&pageNow=${pageList.getUpPage()}'>上一页</a>
                        </li>
                        ...
                        <li class="threeword"><a
                                href='routeServlet?method=getRouteListByCid&cid=${pageList.list[0].cid}&pageNow=${pageList.getDownPage()}'>下一页</a>
                        </li>
                        <li class="threeword"><a
                                href='routeServlet?method=getRouteListByCid&cid=${pageList.list[0].cid}&pageNow=${pageList.getLastIndex()}'>末页</a>
                        </li>
                    </ul>
        ...
        <div class="contant">
            ...
            <div class="xinxi clearfix">
                ...
                <div class="pageNum">
                    <ul id='writePage'>
                        <li>
                            <a href='routeServlet?method=searchRouteListByTextWithPage&searchtext=${search_text}&pageNow=1'>首页</a>
                        </li>
                        <li class="threeword"><a
                                href='routeServlet?method=searchRouteListByTextWithPage&searchtext=${search_text}&pageNow=${pageList_Search.getUpPage()}'>上一页</a>
                        </li>
                        <script type="text/javascript">
                        ...
                        <li class="threeword"><a
                                href='routeServlet?method=searchRouteListByTextWithPage&searchtext=${search_text}&pageNow=${pageList_Search.getDownPage()}'>下一页</a>
                        </li>
                        <li class="threeword"><a
                                href='routeServlet?method=searchRouteListByTextWithPage&searchtext=${search_text}&pageNow=${pageList_Search.getLastIndex()}'>末页</a>
                        </li>
                    </ul>
