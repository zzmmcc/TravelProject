...
<div class="wrap">
    ...
    <div class="operate">
        <form action="${pageContext.request.contextPath}/adminUserServlet?method=getUserListBySearch_textWithPage&pageNow=1"
              method="post">
            <input id="search_text" name="search_text" class="textBox length-long" placeholder="输入用户姓名"
                   value="${search_text}"/>
    ...
    <table class="list-style Interlaced">
        ...
        <c:forEach items="${pageList.list}" var="u">
            <tr>
                ...
                <td class="center">
                    <a href="${pageContext.request.contextPath}/adminUserServlet?method=getUserMsgsByUid&uid=${u.uid}"
                       class="inline-block" title="查看用户信息"><img src="admin/images/icon_view.gif"/></a>
                </td>
            </tr>
        </c:forEach>
